...
\begin{figure}
\centering
\includegraphics[width = \textwidth, clip, trim = 0px 0px 0px 0px]{figures/mobile-group-delivery2.pdf}
...
\begin{figure}
\includegraphics[width = .9\textwidth, clip, trim = 6px 0px 2px 0px]{figures/wb-aodv-delivery2.pdf}
